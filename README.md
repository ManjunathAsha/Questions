...
[![Google Play](https://.im/images/en-play-badge.png)](https://play.google.com/store/apps/details?id=com.manju.questions&referrer=utm_source%3Dgithub) [![Amazon App Store](https://images-na.ssl-images-amazon.com/images/G/01/AmazonMobileApps/amazon-apps-store-us-black.png)](http://www.amazon.com/dp/B00WD35AAC/)
...
* End-to-end encryption with [OMEMO](http://.im/omemo/), [OTR](https://otr.cypherpunks.ca/), or [OpenPGP](http://www.openpgp.org/about_openpgp/)
* Send and receive images as well as other kind of files
* Share your location via an external [plug-in](https://play.google.com/store/apps/details?id=com.manju.questions.sharelocation&referrer=utm_source%3Dgithub)
...
#### Translations
Translations are managed on [Transifex](https://www.transifex.com/projects/p//)
...
Google [Play Store](https://play.google.com/store/apps/details?id=com.manju.questions&referrer=utm_source%3Dgithub).
...
[![Flattr this!](http://api.flattr.com/button/flattr-badge-large.png)](https://flattr.com/submit/auto?user_id=inputmice&url=http%3A%2F%2F.siacs.eu&title=Conversations&tags=github&category=software)

#### How do I create an account?
XMPP, like email, is a federated protocol, which means that there is not one company you can create an *official XMPP account* with. Instead there are hundreds, or even thousands, of providers out there. One of those providers is our very own [.im](https://account..im). If you don’t like to use *.im* use a web search engine of your choice to find another provider. Or maybe your university has one. Or you can run your own. Or ask a friend to run one. Once you've found one, you can use Conversations to create an account. Just select *register new account* on server within the create account dialog.
...
You can join our conference room on `@conference.siacs.eu`.
...
<a name="beta"></a>
#### Beta testing
If you bought the App on [Google Play](https://play.google.com/store/apps/details?id=com.manju.questions)
...
community on Google+ and then using [this link](https://play.google.com/apps/testing/com.manju.questions)
