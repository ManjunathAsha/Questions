...
####Version 1.2.0
* Send current location. (requires [plugin](https://play.google.com/store/apps/details?id=com.manju.questions.sharelocation))
...
####Version 0.7
* Ability to disable notifications for single
